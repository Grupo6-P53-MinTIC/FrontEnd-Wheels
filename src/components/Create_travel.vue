<template>
  <div class="row justify-content-end me-lg-5 m-2">
    <div
      class="col-lg-8 col-sm-12 col-md-8 mt-4 borderR bg-light bg-gradient bg-opacity-50"
    >
      <br />
            ...
            <tr>
              ...
              <td>
                ...
                >
                  ...
                  <option v-for="city in getAllCities" :value="city.nameCity">
                    {{ city.nameCity }}
                  </option>
                </select>
              </td>
  ...
  methods: {
    ...
    createTravel: async function () {
      ...
      await this.$apollo
        ...
        .then((result) => {
          this.createChat(result.data.addTravel);
